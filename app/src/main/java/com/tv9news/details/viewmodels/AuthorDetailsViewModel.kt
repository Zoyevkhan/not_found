...
import com.tv9news.models.authors.AuthorDetailApi
...
class AuthorDetailsViewModel(@NonNull application: Application
    ...
    fun callDetailsApi(encryptionStr: String) {
        viewModelScope.launch(baseExceptionHandler) {
            ...
            val response = webservice.getAuthorDetails(encryptionStr)
                ...
                if (status && result != null) {
                    ...
                    try {
                        ...
                        if (jsonObject.getBoolean("status")) {
                            val detailsData: AuthorDetailApi =
                                Gson().fromJson(jsonObject.toString(), AuthorDetailApi::class.java)
    ...
    var _detailsDataList = MutableLiveData(emptyList<AuthorDetailsData>())
    val detailsDataList: LiveData<List<AuthorDetailsData>> get() = _detailsDataList
