...
class GridTrendTopicItemAdapter(
    private val mItems: List<Articles>,
    val homeItemClick: HomeItemClick
) :
    RecyclerView.Adapter<GridTrendTopicItemAdapter.DivItemViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DivItemViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.grid_trend_topic_item_child, parent, false)
